...
class MainClass{
    ...
    public static void main(String[] args) {
        Person1 p1 = new Person1();                     //Method 1
        p1.run("Arvind",23);

        PersonActivity p2 = new PersonActivity() {          //Method 2
            public void run(String name, int v) {
        ...
        PersonActivity p3 = (name,v) -> System.out.println(name+" is running at : "+ v+"kms");      //Method 3
